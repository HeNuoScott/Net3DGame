			...
			get{
				if( _instance == null ){
					...
					if( _instance == null ){
						...
						//#elif UNITY_2018
						//PrefabUtility.SaveAsPrefabAsset(new GameObject("StateMachineSetting").AddComponent<StateMachineSetting>().gameObject, "Assets/GameDesigner/Editor/Resources/StateMachineSetting.prefab");
						//#endif
                        _instance = Resources.Load<StateMachineSetting>("StateMachineSetting");
					}
				}
