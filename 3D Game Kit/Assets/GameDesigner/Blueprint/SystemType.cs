		...
		static public void SetFieldValue( object target , object setValue ) 
		{
			foreach( FieldInfo field in target.GetType().GetFields() ){
				if (field.IsStatic|field.IsPrivate|field.FieldType.IsAbstract)
					continue;
				if ( SystemType.IsSubclassOf( field.FieldType , typeof(UnityEngine.Object) ) | field.FieldType == typeof(string) | field.FieldType.IsValueType | field.FieldType.IsEnum | field.FieldType.IsArray ) {
